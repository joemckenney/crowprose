...
type Route = Record<string, () => Promise<{ default: ComponentType<any> }>>;
const regularRoutes = Object.keys(ROUTES as Route).reduce((routes, path) => {
  let route = path
    // `pages/index.page.js → /`
  ...
  return {
    ...
    [route]: {
      route,
      Component: lazy((ROUTES as Route)[path]),
    },
  };
}, {});
